...
@app.post("/heroes/", response_model=HeroRead, tags=["Heroes"])
...
@app.get("/heroes/{hero_id}", response_model=HeroReadWithTeam, tags=["Heroes"])
...
@app.get("/teams/{team_id}", response_model=TeamReadWithHeroes, tags=["Teams"])
...
@app.patch("/teams/{team_id}", response_model=TeamRead, tags=["Teams"])
def update_team(
    *,
    session: Session = Depends(get_session),
    team_id: int,
